Primeiramente você deve ativar o xamp e ativar as funções para poder executar o php e o sql, logo após fazer isso coloque o banco no MySQL para que possa ser utilizado,
